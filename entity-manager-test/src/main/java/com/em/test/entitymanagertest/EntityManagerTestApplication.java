...
public class EntityManagerTestApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * dealerMaster2.setDealerCode("dc456"); dealerMaster2.setDealerName("Pawan");
		 * 
		 * VinMaster vinMaster = new VinMaster(); vinMaster.setVin("vin123");
		 * vinMaster.setDealerCode("dc123"); vinMaster.setDealerSiteCode("sc123");
		 * vinMaster.setOrderNumber("on123"); vinMaster.setContractNumber("cn123");
		 * 
		 * List<DealerMaster> dealerMasters = Arrays.asList(dealerMaster1,
		 * dealerMaster2);
		 * 
